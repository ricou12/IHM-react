...
export default function MotorCommand({showCommand}) {
    return (
        <div className={`col-6 order-2 col-xl-3 order-xl-1 d-flex flex-column align-items-center mt-2 ${showCommand}`} id="container__boxMoteur">
            <div className="boxTitleHaut">
                <h5 className="sousTitre text-center">Commandes moteurs</h5>
            </div>

            <div className="grid-containerMoteurs">
                <div className="moteurs-avt">
                ...
                <div className="moteurs-vitesse rounded border border-dark d-flex flex-column align-items-center justify-content-around">
                    ...
                    <div className="slider-wrapper slider p-2">
                        <input type="range" className="slider-moteurs" min="105" max="255" step="10" defaultValue="175" />
                    </div>
                </div>
            </div>
